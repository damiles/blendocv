...
//	register_node_type_cmp_whileloop(ntypelist);
	...
	register_node_type_cmp_cvdilate(ntypelist);
	register_node_type_cmp_cvdiv(ntypelist);
	register_node_type_cmp_cvdrawcontour(ntypelist);
	register_node_type_cmp_cverode(ntypelist);
